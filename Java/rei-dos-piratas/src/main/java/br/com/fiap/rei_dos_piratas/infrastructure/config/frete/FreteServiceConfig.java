...
public class FreteServiceConfig {
    @Bean
    public FreteService freteService(TokenService tokenService, ProdutoService produtoService, ObjectMapper mapper) {
        return new FreteServiceImpl(tokenService, produtoService, mapper);
    }
}
