...
public record ProdutoInDto(
        ...
        @NotNull(message = "O autor do produto não pode ser nulo")
        ...
        @Digits(fraction = 2, integer = 6, message = "O preço original do produto deve ter até 8 digitos com 2 dígitos após a vírgula")
        @DecimalMin(value = "0.0", inclusive = false, message = "O preço original do produto não pode ser negativo")
